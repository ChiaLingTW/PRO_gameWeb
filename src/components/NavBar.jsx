          ...
          <nav className="NavBar row ">
            ...
            {this.state.data.mail ? (
              <div className="shoppingcart col-1 ">
                ...
                <div className="MemberInfo col-1 mx-ms-4" onClick={this.DropDonw}>
                  <img style={{ cursor: "pointer" }} src={require("../img/member.jpg")} alt="member" />
                </div>
              </div>
            ) : (
              <div className="col-1 shoppingcart justify-content-end">
                <div>
                  <a href="/memberLogin" className="btn btn-success">登入</a>
                </div>
              </div>
            )}
          </nav>
